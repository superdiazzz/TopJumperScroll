...
public abstract class MyBaseViewAnimator {
    ...
    public MyBaseViewAnimator setTarget(View target) {
        reset(target);
        prepare(target);
        return this;
    }
    ...
    public MyBaseViewAnimator setDuration(long duration) {
        mDuration = duration;
        return this;
    }

    public MyBaseViewAnimator setStartDelay(long delay) {
    ...
    public MyBaseViewAnimator addAnimatorListener(Animator.AnimatorListener l) {
    ...
    public MyBaseViewAnimator setInterpolator(Interpolator interpolator) {
    ...
    public MyBaseViewAnimator setRepeatTimes(int repeatTimes) {
        mRepeatTimes = repeatTimes;
        return this;
    }

    public MyBaseViewAnimator setRepeatMode(int repeatMode) {
